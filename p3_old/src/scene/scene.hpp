...
public:
    ...
    */
    ...
    /**
     * Turn this function to virtual to be overriden by Model class for adding bounding volume
     */ 
    virtual bool initialize();

    /**
    * Check whether the given ray is intersected with the geometry.
    */
     ...
     */
    virtual real_t getIntersectionTime() = 0;

    /**
     * Get the normal at the intersection in Global Space
     */
    virtual Vector3 getIntersectionNormal() = 0;

    /**
     * Get the position of the intersection in Global Space
     */
    virtual Vector3 getIntersectionPosition(Ray ray) = 0;

    /**
     * Get the texture color at the intersection position
     */
    virtual Color3 getIntersectionTextureColor(Ray ray) = 0;	

    /**
     * Get the ambient color at the intersection position
     */
    virtual Color3 getIntersectionAmbientColor() = 0;

    /**
     * Get the diffuse color at the intersection position
     */
    virtual Color3 getIntersectionDiffuseColor() = 0;
	
    /**
     * Get the specular color at the intersection position
     */
    virtual Color3 getIntersectionSpecularColor() = 0;

    /**
     * Get the refractive index at the intersection position
     */
    virtual real_t getIntersectionRefIndex() = 0;
};
